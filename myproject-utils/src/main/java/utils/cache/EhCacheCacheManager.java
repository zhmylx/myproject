...
import utils.cache.info.CacheManagerInfo;
 ...
 {
   private static final Log logger = LogFactory.getLog(EhCacheCacheManager.class);
   ...
   public Object getCache(String key)
   {
     ...
     if (logger.isDebugEnabled()) {
       logger.debug(Datas.join(new Object[] { "Retrieve data key=", key, ",value=", value }));
     }
     return value;
   }
   ...
   public void putCache(String key, Object value)
   {
     ...
     if (logger.isDebugEnabled())
       logger.debug(Datas.join(new Object[] { "Put cache key=", key, ",value=", value }));
   }
   ...
   public void clearCache(Object[] arguments)
   {
     ...
     if (logger.isWarnEnabled())
       logger.warn(Datas.join(new Object[] { "Clear ", this.cacheName, " ", Integer.valueOf(size), " item(s).prefix=", keyPrefix }));
   }
