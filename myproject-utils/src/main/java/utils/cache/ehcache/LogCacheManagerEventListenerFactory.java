     ...
     return new CacheManagerEventListener() {
       ...
       public void notifyCacheAdded(String cacheName) {
         if (LogCacheManagerEventListenerFactory.logger.isInfoEnabled())
           LogCacheManagerEventListenerFactory.logger.info(Datas.join(new Object[] { "Cache [", cacheName, "] added" }));
       }
 
       public void notifyCacheRemoved(String cacheName)
       {
         if (LogCacheManagerEventListenerFactory.logger.isInfoEnabled())
           LogCacheManagerEventListenerFactory.logger.info(Datas.join(new Object[] { "Cache [", cacheName, "] removed" }));
       }
     };
   }
 ...
 * Qualified Name:     ins.framework.cache.ehcache.LogCacheManagerEventListenerFactory
