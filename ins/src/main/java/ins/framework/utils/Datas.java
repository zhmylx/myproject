...
public final class Datas {
	...
	private static final String[] TRUE_ARRAY = { "y", "yes", "true", "t", "是",
			"1" };

	private static final String[] FALSE_ARRAY = { "n", "no", "false", "f", "否",
			"0" };
 ...
 * Qualified Name: ins.framework.utils.Datas JD-Core Version: 0.5.4
 */